function [opairs, dpairs] = FindOverlappingPlaceFields(S, Xtsd, Ytsd, epoch, overlapFactor, varargin)
...
num_possile_pairs = factorial(length(S))/(factorial(2)*factorial(length(S)-2));
...
%% Clean the resulting varialbles
